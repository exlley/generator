...
public class DatabaseIntrospector {
    ...
    private List<IntrospectedTable> calculateIntrospectedTables(TableConfiguration tc,
        ...
        for (Map.Entry<ActualTableName, List<IntrospectedColumn>> entry : columns.entrySet()) {
            ...
            FullyQualifiedTable table = new FullyQualifiedTable(
                    ...
                    stringHasValue(tc.getSchema()) ? atn.getSchema() : null, atn.getTableName(), tc.getTableName(),
                    ...
                    tc.getDomainObjectRenamingRule(), tc.isSuffixAsPackage(), context);
     ...
     *            the introspected table to enhance
     */
