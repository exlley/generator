...
public interface Plugin {
     ...
     * 
     * @param warnings
     *            add strings to this list to specify warnings. For example, if the plugin is invalid, you should
    ...
    /**
     * This method is called when the count method has been generated for the mapper interface. This method is only
     * called in the MyBatis3DynamicSql runtime.
     * 
     * @param method
    ...
    /**
     * This method is called when the delete method has been generated for the mapper interface. This method is only
     * called in the MyBatis3DynamicSql runtime.
     * 
     * @param method
    ...
    /**
     * This method is called when the insert method has been generated for the mapper interface. This method is only
     * called in the MyBatis3DynamicSql runtime.
     * 
     * @param method
    ...
    /**
     * This method is called when the selectMany method has been generated for the mapper interface. This method is only
     * called in the MyBatis3DynamicSql runtime.
     * 
     * @param method
    ...
    /**
     * This method is called when the selectOne method has been generated for the mapper interface. This method is only
     * called in the MyBatis3DynamicSql runtime.
     * 
     * @param method
    ...
    /**
     * This method is called when the update method has been generated for the mapper interface. This method is only
     * called in the MyBatis3DynamicSql runtime.
     * 
     * @param method
     ...
     * @param topLevelClass
     *            the partially implemented model class. You can add additional imported classes to the implementation
     *            class if necessary.
     ...
     * be called if the table rules call for generation of a primary key class. <br>
     * <br>
     ...
     * be called if the table rules call for generation of a base record class. <br>
     * <br>
     ...
     * only be called if the table rules call for generation of a record with BLOBs class. <br>
     * <br>
     * This method is only guaranteed to be called by the default Java model generators. Other user supplied generators
     * may, or may not, call this method.
     * 
     ...
     * called if the table rules call for generation of an example class. <br>
     * <br>
     * This method is only guaranteed to be called by the default Java model generators. Other user supplied generators
     * may, or may not, call this method.
     * 
     ...
     * 
     * @param sqlMap
     *            the generated file (containing the file name, package name, and project name)
     * @param introspectedTable
     *            The class containing information about the table as introspected from the database
     ...
     * 
     * @param document
     *            the generated document (note that this is the MyBatis generator's internal Document class - not the
     *            w3c XML Document class)
     * @param introspectedTable
     *            The class containing information about the table as introspected from the database
     ...
     *         if any plugin returns false, then the <code>sqlMapGenerated</code> method will not be called.
     */
     ...
     * @param topLevelClass
     *            the partially generated provider class You can add additional imported classes to the class if
     *            necessary.
     * @param introspectedTable
     *            The class containing information about the table as introspected from the database
     * @return true if the method should be generated, false if the generated method should be ignored. In the case of
     ...
     *         multiple plugins, the first plugin returning false will disable the calling of further plugins.
     */
    boolean providerSelectPaginationByExampleWithBLOBsMethodGenerated(Method method, TopLevelClass topLevelClass,
                                                            IntrospectedTable introspectedTable);
     ...
     *         multiple plugins, the first plugin returning false will disable the calling of further plugins.
     */
    boolean providerSelectPaginationByExampleWithoutBLOBsMethodGenerated(Method method, TopLevelClass topLevelClass,
                                                               IntrospectedTable introspectedTable);
    /**
